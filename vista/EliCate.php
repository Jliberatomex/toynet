...
<div id="fh5co-wrapper">
    ...
    <div class="container" id="log-in-form">
        ...
        <form role="form" name="EliminarCate" action="../controlador/CategoriaCtrl.php" method="post"  >  <!--   -->
 
  <input type="hidden" name="accion" value="EliminarCate" />
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" readonly value="<?php echo $cate->getNombre_Categoria(); ?>" name="nombre_Categoria" required>
  </div>
  
  

  <input name="button" type=button onclick="if(confirm('Esta seguro que desea eliminar esta Categoria?')){
          this.form.submit();}else{ ;
          }"  value="Eliminar" class="btn btn-danger"  />
          <a href="../vista/categoria.php"/> <button type="button" class="btn btn-danger"   data-dismiss="modal">   Cancelar</button>
</form>
