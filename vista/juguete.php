	...
	<h1>Juguetes<h1>	
		...
		<div class="container-table100">
				<div class="table100 ver2 m-b-110">
					<table data-vertable="ver2">
						<thead>
							<tr class="row100 head">
							   <!-- <th class="column100 column1" data-column="column1">ID</th> -->
								...
								<th class="column100 column3" data-column="column3">Descripcion</th>
								<!--<th class="column100 column4" data-column="column4">Imagen</th> -->
								<th class="column100 column4" data-column="column4">Costo</th>
								<th class="column100 column5" data-column="column5">Imagen</th>
								<th class="column100 column6" data-column="column6">Marca</th>
								<th class="column100 column7" data-column="column7">Categoria</th>
						...
						<tbody>
							<?php foreach($misjugue as $j ) { ?>
								<tr>
									<td><?php echo $j->getNombre_Juguete(); ?></td>
									<td><?php echo $j->getDescripcion_Juguete();?> </td>
									<td><?php echo $j->getPrecio(); ?> </td>
									<td><img class="img-responsive" width="350px" height="450px" src="/ToyNet/imagenes/<?php echo $j->getImagen();?>"></td>
									<td><?php echo $j->getId_Marca(); ?> </td>
									<td><?php echo $j->getId_Categoria(); ?> </td>
									
									<td><a href="../vista/ActJug.php?id_Juguete=<?php echo $j->getid_Juguete(); ?>"><img src="../images/modificar.png" width="35px" height="35px"></a>
										<a href="../vista/EliJug.php?id_Juguete=<?php echo $j->getid_Juguete(); ?>">&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/eliminar.png" width="35px" height="35px"></a>
									</td>
								</tr>
							<?php }  ?>
					...
					<br>
					<tr>
					 <a class="btn btn-primary btn-lg" href="../vista/RegistrarJuguete.php">Agregar</a>
