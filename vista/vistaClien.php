 ...
 <html class="no-js"> 
	...
	<body>
					...
					<div class="nav-header">
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li>
									<a class="fh5co-sub-ddown" href="../vista/jugueteUsuario.php">Juguetes</a>
									<ul class="fh5co-sub-menu">
										<li><a href="../vista/marUsuario.php">Marcas</a></li>
										<li><a href="../vista/cateUsuario.php">Categorias</a></li>
										
										
									</ul>
								</li>
								<li>
									<!-- href="../vista/consMesaRegalo.php"  -->
								  <a href="../vista/consuMesa.php" class="fh5co-sub-ddown">Mesa de Regalo</a>
								<ul class="fh5co-sub-menu">
									<li><a href="../vista/RegistrarMesa.php">Crear Mesa Regalo</a></li>
								</ul>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(../images/portada.jpg);">
					...
					<div class="col-md-4 col-sm-4 fh5co-item-wrap">
						<a class="fh5co-listing-item">
							...
							<div class="fh5co-listing-copy">
								<h2>Juguete del capitan america</h2>
								<span class="icon">
