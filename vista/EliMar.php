...
<div id="fh5co-wrapper">
    ...
    <div class="container" id="log-in-form">
        ...
        <form role="form" name="EliminarMar" onclick="return confirmation();" action="../controlador/MarcaCtrl.php" method="post"  >  <!--   -->
 
  <input type="hidden" name="accion" value="EliminarMar" />
  ...
  <div class="form-group">
    ...
    <input type="text" readonly class="form-control" value="<?php echo $mar->getNombreMarca(); ?>" name="nombreMarca" required>
  </div>
