	...
	<body>
							...
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li>
									...
									<ul class="fh5co-sub-menu">
										...
										<li><a href="../vista/categoria.php">Clasificacion</a></li>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(../images/toys.png);">
				...
				<!--<a  class="btn btn-succes" href="../vista/prueba.php?id_Juguete=<?php //echo $jug->getId_Juguete();?>&action=add">Agregar Mesa</a>
				<!-<button class="btn btn-succes" onclick="add(<?php //echo $jug->getId_Juguete();?>,'add');">Agregar</button> -->
