						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li>
								  ...
								  <a href="../vista/mesa.php" class="fh5co-sub-ddown">Mesa de Regalo</a>
								<ul class="fh5co-sub-menu">
									<li><a href="../vista/RegistrarMesa.php">Crear Mesa Regalo</a></li>
									<li><a href="../vista/RegistrarMesa.php">Consultar</a></li>
								</ul>
					...
					<div class="row">
						...
						<br>
							...
							<div class="col-md-4 col-sm-4 fh5co-item-wrap">
								<a class="fh5co-listing-item" href="../vista/descripcionJuguete.php?id_Juguete=<?php echo $j->getid_Juguete(); ?>">
