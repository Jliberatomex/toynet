...
/**
   ...
   */
	...
	$mes=new MesaJu();
	$mes=buscarMesaJu($_GET['id_Detalle'])
...
<div id="fh5co-wrapper">
    ...
    <div class="container" id="log-in-form" >
        <div class="heading">
            <h1>Eliminar Juguete Mesa</h1>
        </div>
        <form class="well-lg form-horizontal" name="EliminarJugueMesa" action="../controlador/MesaCtrl.php" method="post">
        		<input type="hidden" name="accion" value="EliminarJugueMesa">
			<input type="hidden" class="form-control" value="<?php echo $mes->getId_Detalle(); ?>" name="id_Detalle">
            <div class="form-group">
            	<label for="name">Nombre del Juguete</label>
                <input type="text" class="form-control" readonly value="<?php echo $mes->getId_Juguete(); ?>" id="nombre_Juguete" name="nombre_Juguete" placeholder="Nombre del juguete">
            </div>
			<br>
            ...
            <div class="form-group form-group-btn">
				...
				<input name="button" type=button onclick="if(confirm('Esta seguro que desea eliminar este Juguete de la mesa?')){
					this.form.submit();}else{ ;
					}"  value="Eliminar" class="btn btn-danger"	 />
  				<a href="../vista/mesa.php"/> <button type="button" class="btn btn-danger"   data-dismiss="modal">   Cancelar</button>
            </div>   
