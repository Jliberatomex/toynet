...
<div id="fh5co-wrapper">
    ...
    <div class="container" id="log-in-form">
        ...
        <form role="form" name="ActualizarMar" action="../controlador/MarcaCtrl.php" method="post" enctype="multipart/form-data"> 
 
  <input type="hidden" name="accion" value="ActualizarMar" />
   <div class="form-group">
   <!-- <label for="name">Clave</label> -->
    <input type="hidden" class="form-control" value="<?php echo $mar->getId_Marca(); ?>" name="id_Marca" required >
  </div>
  <div class="form-group">
    <label for="name">Nombre Marca</label>
    <input type="text" class="form-control" value="<?php echo $mar->getNombreMarca(); ?>"   name="nombreMarca" required>
  </div>

  <div class="form-group">
    <label for="name">Descripcion Marca</label>
    <input type="text" class="form-control" value="<?php echo $mar->getDescripcionMarca(); ?>" name="descripcionMarca" required>
  </div>
  <div class="form-group">
