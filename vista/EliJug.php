...
<div id="fh5co-wrapper">
    ...
    <div class="container" id="log-in-form" >
        <div class="heading">
            <h1>Eliminar Juguete</h1>
        </div>
        <form class="well-lg form-horizontal" name="EliminarJugue" action="../controlador/JugueteCtrl.php" method="post">
        		<input type="hidden" name="accion" value="EliminarJugue">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" readonly value="<?php echo $jug->getNombre_Juguete(); ?>" id="nombre_Juguete" name="nombre_Juguete" placeholder="Nombre del juguete">
            </div>

            
			<!--<div class="form-group">
                <input type="file" class="form-control" id="apellidoM" placeholder="Introducir imagen">
            </div>-->
            ...
            <div class="form-group form-group-btn">
				...
				<input name="button" type=button onclick="if(confirm('Esta seguro que desea eliminar este Juguete?')){
					this.form.submit();}else{ ;
					}"  value="Eliminar" class="btn btn-danger"	 />
  				<a href="../vista/juguete.php"/> <button type="button" class="btn btn-danger"   data-dismiss="modal">   Cancelar</button>
            </div>   
