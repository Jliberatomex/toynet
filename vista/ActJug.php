...
<div id="fh5co-wrapper">
    ...
    <div class="container" id="log-in-form" >
        ...
        <form class="well-lg form-horizontal" name="ActualizarJugue" enctype="multipart/form-data"  action="../controlador/JugueteCtrl.php" method="post">
        		<input type="hidden" name="accion" value="ActualizarJugue">
